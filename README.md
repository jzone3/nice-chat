...
[![Built by Devin](https://raw.githubusercontent.com/club-cog/built-by-devin/main/badges/built-by-devin.svg)](https://builtbydevin.ai/) · [By Jared](https://x.com/imjaredz)
...
| `is_negative` | Noul | Negative in spirit — complaining, venting, sad news with no upside: "this sucks", "I feel crappy", "so bored", "my cat died today"? Not mean, but not nice either, so it blocks with a "keep it positive" tip. Plain neutral talk (questions, facts) and sad-but-warm messages ("rough day, but this room cheers me up") pass. |
...
calls per UTC day, default 12500 ≈ $1/day), `JEV_PREVIEW_SHARE` (share of the budget after which the
...
Made with 💖 · [Built with Devin](https://builtbydevin.ai/) · [By Jared](https://x.com/imjaredz)
